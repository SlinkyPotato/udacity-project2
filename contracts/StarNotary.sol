...
contract StarNotary is ERC721 {
    ...
    constructor() public ERC721("CoolStar", "SNT") {}    
    ...
    // Overloaded function to pass same token ID
    function createStar(string memory _name, uint256 _tokenId) public {
        createStar(_name, 'SNT', _tokenId);
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender, "You must be the owner of the token");
        ...
        transferFrom(token1Address, token2Address, _tokenId1);
        transferFrom(token2Address, token1Address, _tokenId2);
    }
